...
IEnumerable<T> Filter<T>(IEnumerable<T> heroes, Func<T, bool> f) //This is a generic filter capable of filtering any type of object for any condition same as like LINQ where
{
